 ...
 * 
 * Cette classe depend de la classe Piece. Elle peut construire un objet pion noir et defini les deplacements possibles.
 * 
 * 
 * @author Kabeya Jude
 * @version V1
...
public class PionNoir extends Pion{
    ...
    /** 
     * Cree un pion blanc en position A1
    */
    public PionNoir(){
        super();
    }
    ...
    public ArrayList<Position> getDeplacementPossible(Plateau p){
        ...
        if ((p.getCase(posPiece.getX() + 1, posPiece.getY() - 1) != null)){
            ...
            if (p.getCase(posPiece.getX() + 1, posPiece.getY() - 1).getCouleur() == 'B'){
